...
// Example usage for websocket over SSH:
/*
Usage:
1. Start websocket server on remote machine (e.g., on port 8080)
2. Create SSH tunnel: tunnel, err := sshClient.SetupWebsocketTunnel("9090", "localhost", 8080)
3. Connect websocket client to ws://localhost:9090
4. Traffic will be forwarded through SSH to remote ws://localhost:8080
*/
